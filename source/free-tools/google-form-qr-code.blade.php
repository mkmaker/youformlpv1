                    ...
                    <div 
                        ...
                        <form action="#" @submit.prevent="generate" class="mt-4">
                            <div>
                                ...
                                <input x-model="url" type="text" name="url" id="url" class="block mx-auto w-full mt-2 rounded-md py-2.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 border-2 border-black placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-gray-800 sm:text-sm sm:leading-6" placeholder="Paste Your Google Form URL">
                            </div>
