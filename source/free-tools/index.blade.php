        ...
        <div class="max-w-6xl mx-auto px-4 pb-20">
            ...
            <div class="mb-16">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    {{-- SurveyMonkey QR Code --}}
                    <a href="/free-tools/surveymonkey-qr-code/" class="group block bg-white rounded-xl border border-gray-200 p-6 hover:shadow-lg hover:border-purple-300 transition-all">
                        <div class="flex items-start justify-between">
                            <div>
                                <h3 class="font-semibold text-gray-900 group-hover:text-purple-600">SurveyMonkey QR Code Generator</h3>
                                <p class="text-gray-600 text-sm mt-1">Generate QR codes for your SurveyMonkey surveys instantly</p>
                            </div>
                            <span class="text-2xl">📱</span>
                        </div>
                    </a>

                    {{-- AI Signature Generator - removed, doing separately --}}
