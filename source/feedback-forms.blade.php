        ...
        <div class="bg-white border-2 border-black rounded-xl overflow-hidden mb-8" id="template-5">
            <div class="md:flex">
                ...
                <div class="md:w-3/5 p-8">
                    ...
                    <a href="/templates/t/website-design-feedback-form-template" class="inline-block bg-coral border-2 border-black px-6 py-2 rounded-md font-semibold hover:drop-shadow-3xl transition-all">
                        Use this template →
                    </a>
                </div>
            </div>
        ...
        <div class="bg-gray-50 border-2 border-black rounded-xl overflow-hidden mb-8" id="template-7">
            <div class="md:flex">
                ...
                <div class="md:w-3/5 p-8">
                    ...
                    <a href="/templates/t/workshop-feedback-survey-template" class="inline-block bg-coral border-2 border-black px-6 py-2 rounded-md font-semibold hover:drop-shadow-3xl transition-all">
                        Use this template →
                    </a>
                </div>
            </div>
