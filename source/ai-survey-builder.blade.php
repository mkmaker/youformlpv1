            ...
            <div class="flex flex-col justify-center items-center px-10 md:px-20">
                <div class="text-center max-w-4xl mx-auto">
                    <p class="text-xs font-semibold px-4 py-1.5 rounded-full mb-3 lg:mb-4 bg-pale-violet border border-black inline-block">
                        Free AI-powered survey maker
                    </p>
                    <h1 class="text-3xl sm:text-5xl xl:text-6xl font-bold xl:leading-tight">
                        AI Survey Builder
                    </h1>
                    <p class="text-base mt-6 max-w-3xl mx-auto">
                        Create professional surveys in seconds with AI. Describe what you want to learn, and our AI survey generator builds questions, suggests logic, and helps you gather insights faster — free, no coding required.
                    </p>
