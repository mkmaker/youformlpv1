...
<div class="bg-vivid-yellow py-20" id="templates">
    <div class="max-w-7xl mx-auto px-10 md:px-20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            ...
            <a href="/templates/t/contact-us-form-template" class="bg-white border-2 border-black rounded-xl p-6 drop-shadow-4xl hover:drop-shadow-6xl transition-all">
                <div class="text-3xl mb-3">📧</div>
            ...
            <a href="/templates/t/request-a-quote-form-template" class="bg-white border-2 border-black rounded-xl p-6 drop-shadow-4xl hover:drop-shadow-6xl transition-all">
                <div class="text-3xl mb-3">💰</div>
            ...
            <a href="/templates/t/newsletter-signup-form-template" class="bg-white border-2 border-black rounded-xl p-6 drop-shadow-4xl hover:drop-shadow-6xl transition-all">
                <div class="text-3xl mb-3">📰</div>
                <h3 class="text-xl font-bold mb-2">Newsletter Signup</h3>
                <p class="text-gray-700 text-sm">
                    Simple, high-converting newsletter subscription form. Just email and optional name for maximum conversion.
                </p>
            </a>

            <a href="/templates/t/event-registration-form-template" class="bg-white border-2 border-black rounded-xl p-6 drop-shadow-4xl hover:drop-shadow-6xl transition-all">
                <div class="text-3xl mb-3">📅</div>
            ...
            <a href="/templates/t/free-trial-signup-form-template" class="bg-white border-2 border-black rounded-xl p-6 drop-shadow-4xl hover:drop-shadow-6xl transition-all">
                <div class="text-3xl mb-3">✨</div>
                <h3 class="text-xl font-bold mb-2">Free Trial Signup</h3>
                <p class="text-gray-700 text-sm">
                    Optimized for SaaS trial signups. Captures work email, company info, and use case with minimal friction.
                </p>
            </a>
        </div>
