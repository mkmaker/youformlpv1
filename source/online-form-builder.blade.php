    ...
    <div class="bg-medium-champagne bg-cover bg-no-repeat bg-center">
        ...
        <div class="relative max-w-7xl mx-auto mt-10 pb-20">
            <div class="flex flex-col justify-center items-center px-10 md:px-20">
                <div class="text-center">
                    <h1 class="text-3xl sm:text-5xl xl:text-6xl font-bold xl:leading-tight">
                        ...
                        <span class="relative inline-block ml-1 mt-2 sm:mt-0">
                            ...
                            <span class="relative z-10 p-2 inline-block rotate-6">100% Free</span>
                        </span>
                    </h1>
                ...
                <div class="w-full h-full mt-10 hidden md:block">
                    <iframe src="https://app.youform.com/forms/xrjcjyti" loading="lazy" width="100%" height="700" frameborder="0" marginheight="0" marginwidth="0" class="rounded-md shadow border-2 border-black drop-shadow-6xl"></iframe>
                </div>

                <div class="text-center mt-8 mx-auto md:hidden">
                    <a href="https://app.youform.com/forms/xrjcjyti" target="_blank" class="text-black underline">
                        Try a sample form &rarr;
                    </a>
                </div>
            </div>
        </div>
