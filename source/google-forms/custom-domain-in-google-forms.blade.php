---
title: "Google Forms Custom URL & Custom Domain — How to Brand Your Form Link"
description: "Google Forms doesn't support a custom URL or custom domain natively. Here's how to brand your Google Forms link with Workspace — and a simpler free alternative."
---
            ...
            <div class="flex flex-col justify-center items-center px-10 md:px-20">
                <div class="text-center max-w-4xl mx-auto">
                    ...
                    <p class="text-base mt-6 max-w-3xl mx-auto">
                        Google Forms doesn't let you set a custom URL or custom domain out of the box — every link looks like <code class="bg-white/60 px-1.5 py-0.5 rounded text-sm">docs.google.com/forms/d/e/1FAIpQLSe…</code>. Here's how to brand your Google Forms link with a Google Workspace setup, and the simpler free alternative most people end up switching to.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
            ...
            <div class="lg:col-span-8 lg:col-start-3">
                <div class="mb-12 pt-10 lg:pt-16" id="understanding-custom-domains">
                    <h2 class="text-3xl sm:text-4xl font-bold mb-6">Custom URL vs custom domain — what's the difference?</h2>
                    <p class="text-lg text-gray-700 mb-4">
                        People use the phrases interchangeably, but they mean slightly different things. A <strong>custom URL</strong> is any branded form link that doesn't include <code class="bg-gray-100 px-2 py-1 rounded border border-gray-300">google.com</code> — for example <code class="bg-gray-100 px-2 py-1 rounded border border-gray-300">forms.yourcompany.com/contact</code>. A <strong>custom domain</strong> is the subdomain part (<code class="bg-gray-100 px-2 py-1 rounded border border-gray-300">forms.yourcompany.com</code>) that you point at the form host with a DNS record. Get the domain right, and the URL follows.
                    </p>
                    <p class="text-lg text-gray-700 mb-4">
                        By default, Google Forms supports neither. Every Google Forms URL will be in the format <code class="bg-gray-100 px-2 py-1 rounded border border-gray-300">forms.google.com/...</code> or <code class="bg-gray-100 px-2 py-1 rounded border border-gray-300">docs.google.com/forms/...</code> — you can't have a branded link like <code class="bg-gray-100 px-2 py-1 rounded border border-gray-300">forms.yourcompany.com</code>, and you can't customise the path either.
                    </p>
            ...
            <div class="lg:col-span-8 lg:col-start-3">
                ...
                <div class="mt-10">
                    ...
                    <div x-data="{ open: false }" class="border-y-2 border-black">
                        <div class="w-full cursor-pointer" @click="open = !open">
                            <div class="flex justify-between px-4 py-6 md:text-lg lg:text-2xl">
                                <p class="text-black font-medium flex-grow">Is it possible to customise the URL of a Google Form?</p>
                                <svg x-show="!open" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 md:h-6 md:w-6 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                                </svg>
                                <svg x-show="open" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 md:h-6 md:w-6 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3">
                            ...
                            <div x-show="open">
                                <p class="px-4 py-6 lg:text-lg text-black">
                                    Not really. Google Forms gives every form a long, auto-generated URL like <code class="bg-gray-100 px-2 py-1 rounded border border-gray-300">docs.google.com/forms/d/e/1FAIpQLSe…</code> and there's no setting to change the path, the slug, or the domain. The closest you can get is a Google Workspace custom domain (covered above), which lets you put forms on <code class="bg-gray-100 px-2 py-1 rounded border border-gray-300">forms.yourcompany.com</code> but still locks the path. A URL shortener like Bit.ly hides the ugly link but doesn't make it yours. If you need a fully customisable form URL — branded subdomain plus a clean path — switch to a form builder that supports it. <a href="https://app.youform.com/register" class="text-aquamarine hover:underline font-semibold">Youform lets you set a custom URL and custom domain on both free and paid plans.</a>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div x-data="{ open: false }" class="border-y-2 border-black">
                        <div class="w-full cursor-pointer" @click="open = !open">
                            <div class="flex justify-between px-4 py-6 md:text-lg lg:text-2xl">
                                <p class="text-black font-medium flex-grow">Can I redirect to a custom URL after a Google Form is submitted?</p>
                                <svg x-show="!open" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 md:h-6 md:w-6 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                                </svg>
                                <svg x-show="open" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 md:h-6 md:w-6 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3">
                            ...
                            <div x-show="open">
                                <p class="px-4 py-6 lg:text-lg text-black">
                                    That's a different feature — and Google Forms doesn't support it natively either. The closest you can do is paste a link into the confirmation message and hope respondents click it. We wrote a separate guide on the three workarounds: <a href="/blog/google-forms-redirect-after-submit-solved" class="text-aquamarine hover:underline font-semibold">Google Forms redirect after submit — solved</a>.
                                </p>
                            </div>
                        </div>
                    </div>
