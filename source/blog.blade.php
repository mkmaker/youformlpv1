...
<div class="bg-white pb-20">
    <div class="max-w-7xl mx-auto px-10 md:px-20">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <a href="/blog/how-we-used-sean-ellis-test-to-find-out-our-product-market-fit" class="bg-white group rounded-xl border border-gray-200 overflow-hidden cursor-pointer hover:shadow-lg transition-shadow">
                <div class="px-6 py-6">
