    ...
    <div class="max-w-7xl mx-auto px-10 md:px-20">
        <div class="max-w-3xl mx-auto">
            <article class="prose prose-xl max-w-none" style="font-size: 1.2rem; line-height: 2;">
                ...
                <p>If you need a Microsoft Forms alternative that allows external file uploads, check out <a href="http://www.youform.io" alt="Youform" class="on">Youform</a>.</p><div class="se-component se-image-container __se__float-none" contenteditable="false"><figure style="margin: 0px;"><div class="my-6"><img class="rounded-lg border border-gray-200 w-full" src="/assets/images/youform-file-upload.png" alt="" loading="lazy"></div></figure></div><p>Youform's free plan supports image uploads up to 10mb.</p>
