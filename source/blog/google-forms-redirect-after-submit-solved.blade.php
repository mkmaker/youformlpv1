    ...
    <div class="max-w-7xl mx-auto px-10 md:px-20">
        <div class="max-w-3xl mx-auto">
            <article class="prose prose-xl max-w-none" style="font-size: 1.2rem; line-height: 2;">
                ...
                <p>So you have a Google form and want the user to redirect after they have submitted your form?</p><p>Well Google Forms doesn't provide this out of the box but there are 3 workarounds:</p><h3 class="text-2xl font-bold mt-10 mb-4">1. Make a submit message with your link.</h3><p>Go to your Google Form and click on the <strong>settings tab </strong>and look for the&nbsp;<strong>Presentation&nbsp;</strong>option from the list. Click on expand.</p><div class="my-6"><img class="rounded-lg border border-gray-200 w-full" src="/assets/images/google-forms-confirmation-message.png" alt="Google forms redirect after submit" loading="lazy"></div>  <p>After that, you can edit the <strong>confirmation message&nbsp;</strong>i.e the message shown to users after they have submitted the form. There you can add your link.<br>Pros: Super simple and easy to start.<br>Cons: User has to manually click on the link so technically not a redirect. Sometimes they might simply miss the link and leave thinking they have submitted they form already.</p><h3 class="text-2xl font-bold mt-10 mb-4">2. Embed in your website and use a little code.</h3><p>You can embed your form in your website and then use the following code (courtesy <a href="https://stackoverflow.com/a/54406701" alt="Stackoverflow" target="_blank" rel="noopener">Stackoverflow</a>):<br></p><div class="my-6"><img class="rounded-lg border border-gray-200 w-full" src="/assets/images/google-forms-redirect-embed-code.png" alt="Google form redirect after submit (solution using embed code)" loading="lazy"></div><p>Pros: Better than the option to have user to click a link. User gets auto-redirected after submit.<br>Cons: You need to have your own web page and insert a code into it.</p><h3 class="text-2xl font-bold mt-10 mb-4">3. Use a Google Forms alternative (Free)</h3><p>You can consider using a Google Forms alternative which is free and allows you to redirect users after they have submitted your form. Youform also provides lots of other features which Google Forms lacks for eg:&nbsp;<br></p><p>- Partial submissions: You can view partial records as well even if your form responders don't submit the form.<br>- Beautiful design: Google forms UI is stuck in 90s. Youform provides more modern and polished templates and themes.<br>- Loved by thousands of marketers and businesses like yours. Read all public reviews <a target="_blank" href="https://www.capterra.in/software/1060219/youform" alt="here" rel="noopener">here</a>.</p><p>Pros: Modern, beautiful looking forms with redirect after submit solution out-of-the-box. For teams focused on improving post-submit conversions and lead flow, G2's in-depth guide on <a href="https://www.g2.com/categories/lead-capture#learn-more" target="_blank" rel="noopener">lead capture software</a> offers additional insights into tools designed for this purpose.&nbsp;<br>Cons: Not inside Google so you will have to recreate your form. But you can use our free <a href="https://app.youform.com/googleform-to-youform" target="_blank" rel="noopener">Google Form to Youform converter</a> to migrate your existing form in seconds. Moreover the redirect option is in a pro plan that costs $29/month. Perfect if you need more professional forms but not recommended to spend $29/month for the redirect feature alone if the forms are for casual needs.</p><p>You can try a sample <a href="https://app.youform.com/forms/1sjbgyvl" alt="Youform with redirect here">Youform with redirect here</a>.</p><p class="bg-amber-50 border-2 border-black rounded-lg p-4 my-6"><strong>Related:</strong> if you're trying to brand the form URL itself (not just the post-submit redirect), see our guide on <a href="/google-forms/custom-domain-in-google-forms" class="text-aquamarine hover:underline font-semibold">setting a custom URL or custom domain for Google Forms</a>.</p><p>​</p>
