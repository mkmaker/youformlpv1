<div 
    ...
    <div>
        <div class="mt-10">
            ...
            <input type="range" x-model="submissions" :min="0" :max="50000" :step="100" class="z-10 mb-1 mt-4 h-2 w-full appearance-none bg-slate-800 focus:outline-slate-700 dark:focus:outline-slate-600 [&::-moz-range-thumb]:size-4 [&::-moz-range-thumb]:appearance-none [&::-moz-range-thumb]:border-none [&::-moz-range-thumb]:bg-slate-700 active:[&::-moz-range-thumb]:scale-110 [&::-moz-range-thumb]:dark:bg-slate-600 [&::-webkit-slider-thumb]:size-4 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:border-none [&::-webkit-slider-thumb]:bg-slate-700 [&::-webkit-slider-thumb]:active:scale-110 [&::-webkit-slider-thumb]:dark:bg-slate-600 [&::-moz-range-thumb]:rounded-full [&::-webkit-slider-thumb]:rounded-full rounded-full max-w-xl mx-auto" />
        ...
        <div class="mt-4">
            <label for="needPro" class="inline-flex items-center">
                <input type="checkbox" id="needPro" x-model="needPro" class="form-checkbox h-5 w-5 text-green-700 ring-green-600 ring-1 focus:ring-green-600" />
