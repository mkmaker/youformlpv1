<div class="bg-black space-y-6 lg:space-y-0">
    <div class="space-y-10 lg:space-y-0 mx-auto max-w-6xl flex flex-col lg:flex-row lg:items-start justify-between px-10 md:px-20 py-16">
        <img class="mx-auto lg:mx-0" width="20%" src="/assets/images/Youform-light.png" alt="Youform">
        <br>
        <a href="https://twitter.com/youformio" class="text-white mx-auto lg:mx-0 flex items-center hover:underline" target="_blank">
